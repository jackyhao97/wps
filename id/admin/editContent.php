  ...
  if (isset($_POST['hid_id'])) {
    ...
    if ($block == 0) {
      if ($file != '') {
        ...
        $update_sql = "UPDATE tb_content SET modified_on = '$modified_on', modified_by='$user', judul='$judul', keterangan='$keterangan', path='$new_filename', urutan='$urutan' WHERE id='$id'";
      }
      else {
        $update_sql = "UPDATE tb_content SET modified_on = '$modified_on', modified_by='$user', judul='$judul', keterangan='$keterangan', urutan='$urutan' WHERE id='$id'";
      }
