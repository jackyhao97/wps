...
<body id="page-top">
			...
			<li class="nav-item">
				...
				<div id="collapseThree" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
					<div class="bg-white py-2 collapse-inner rounded">
						...
						<a class="collapse-item active" href="contact.php">Contact</a>
					...
					<div class="card shadow mb-4">
						...
						<div class="card-body">
							<div class="table-responsive">
								<table class="table table-bordered" id="contact-all" width="100%" cellspacing="0">
									<thead>
										<tr>
											<th>#</th>
											<th>Nama</th>
	...
	<script>
		$(document).ready(function() {
			...
			const table = $('#contact-all').on('error.dt', function(e, settings, techNote, message) {
