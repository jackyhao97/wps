...
function ShowImages($data, $judul) {
  $component = '<a href="'.BASE_URL.DS.'admin/img/partners/'.$data.'" data-lightbox="'.$judul.'" data-title="'.$judul.'">';
  $component .= '<img src="'.BASE_URL.DS.'admin/img/partners/'.$data.'" class="w-50" />';
  $component .= "</a>";
