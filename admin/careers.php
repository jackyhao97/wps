...
<body id="page-top">
					...
					<div class="card shadow mb-4">
						...
						<div class="card-body">
							<div class="table-responsive">
								<table class="table table-bordered" id="careers-all" width="100%" cellspacing="0">
									<thead>
										<tr>
											<th>#</th>
											<th>Judul</th>
										...
										<div class="form-group">
											<div class="row">
												...
												<div class="col-md-12 mt-3">
													...
													<input type="file" name="fil_upload_careers" id="fil_upload_careers" data-filename-placement="inside" onchange="resizeAndRead(this)">
													<div class="col-md-8 col-sm-8 col-xs-8">
														<div class="my-gallery">
															<figure id="fil_upload_careers_card">No Image</figure>
														</div>
													</div>
												</div>
											</div>
											...
											<div class="row">
												...
												<div class="col-md-12 mt-3 d-flex align-items-center">
													...
													<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
														<div class="my-gallery">
															<figure id="fil_upload_careers_exist_card">No Image</figure>
														</div>
													</div>
												</div>
												<div class="col-md-12 mt-3">
													<input type="file" name="fil_upload_careers_edit" id="fil_upload_careers_edit" data-filename-placement="inside" onchange="resizeAndReadEdit(this)">
													<div class="col-md-8 col-sm-8 col-xs-8">
														<div class="my-gallery">
															<figure id="fil_upload_careers_edit_card" class="figures">No Preview Available</figure>
														</div>
													</div>
												</div>
											</div>
	...
	<script>
		...
		$(document).ready(function() {
			...
			const table = $('#careers-all').on('error.dt', function(e, settings, techNote, message) {
		...
		function clearForm() {
			$("#txt_judul").val('');
			$("#txt_keterangan").val('');
			$("#fil_upload_careers").val("");
			$("#fil_upload_careers_preview").attr("src", "");
			$("#fil_upload_careers_card").html('No Image');
		}

		function clearFormEdit() {
			$("#txt_judul_edit").val('');
			$("#txt_keterangan_edit").val('');
			$("#fil_upload_careers_edit").val("");
			$("#fil_upload_careers_exist_preview").attr("src", "");
			$("#fil_upload_careers_edit_preview").attr("src", "");
			$("#fil_upload_careers_edit_card").html('No Image');
		}
			...
			$.ajax({
				...
				success: (data) => {
					...
					if (res.success == 1) {
						...
						$('#fil_upload_careers_exist_card').html(
						`<img class="file-card__image w-100" id="fil_upload_careers_exist_preview" src="${mainURL}services/${res.data[0].path}" />`
						);
					}
					else {
