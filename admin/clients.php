...
<body id="page-top">
											...
											<div class="row">
												...
												<div class="col-md-12 mt-3 d-flex align-items-center">
													...
													<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
														<div class="my-gallery">
															<figure id="fil_upload_clients_exist_card">No Image</figure>
														</div>
													</div>
												</div>
												<div class="col-md-12 mt-3">
													<input type="file" name="fil_upload_clients_edit" id="fil_upload_clients_edit" data-filename-placement="inside" onchange="resizeAndReadEdit(this)">
													<div class="col-md-8 col-sm-8 col-xs-8">
														<div class="my-gallery">
															<figure id="fil_upload_clients_edit_card" class="figures">No Preview Available</figure>
														</div>
													</div>
												</div>
											</div>
	...
	<script>
		...
		function clearFormEdit() {
			...
			$("#fil_upload_clients_edit_card").html('No Image');
		}
